          ...
          <div className="md:flex-row flex-col flex  mt-8 gap-2">
            <div className=" w-full md:w-[17%]  flex justify-between md:flex-col ">
              ...
              <div className="pt-1 h-full md:w-full w-[45%]  md:h-1/2">
                <div
                  onClick={navigateToApplications}
                  className="border bg-yellow text-white transition duration-400 h-full cursor-pointer mb-4 p-3 pb-0 flex flex-col justify-between"
                >
            ...
            <div className=" w-full md:w-[17%]  flex justify-between md:flex-col ">
              <div className="pt-1 h-full md:w-full w-[45%]  md:h-1/2">
                <div
                  onClick={navigateToApplications}
                  className="border  bg-orange text-white transition duration-400 h-full cursor-pointer mb-4 p-3 pb-0 flex flex-col justify-between"
                >
