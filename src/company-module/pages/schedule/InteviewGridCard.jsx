...
function InterviewGridCard({ data }) {
...
//   console.log(data);
  ...
  return (
    <div className="flex flex-col rounded-md items-center border border-gray-400 p-5 px-3 gap-3">
      ...
      <div className="flex w-full justify-between px-3 gap-2">
        ...
        <span className="break-all">{data.phone_number}</span>
      </div>
...
export default InterviewGridCard;
