      ...
      <div className="w-full flex flex-col gap-[15px] items-center">
        <div className="flex w-full gap-[10px] items-center">
          ...
          <div className="flex flex-col ">
            <h3 className="text-lg font-semibold">Jerome Bell</h3>
            <span className="text-sm text-gray-400">Producer Design</span>
          </div>
        </div>
        ...
        <div className="w-full h-[100px] flex flex-col gap-[5px] bg-gray-100">
          <div className="w-full flex p-2 border-b border-gray-400 justify-between">
            <span className="text-gray-600 text-little">Applied Jobs</span>
            <span className="text-gray-400 text-little">2 days ago</span>
          </div>
        ...
        <div className="w-full h-[30px] flex justify-between px-2 py-1  gap-[5px] bg-gray-100">
          <span className="text-little">Stage</span>
          <span className="text-little text-primaryColor">Interview</span>
        </div>
