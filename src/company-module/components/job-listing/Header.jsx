function Header({ applicants, options, currentOption, setCurrentOption, job }) {
  return (
      ...
      <div className="flex w-full justify-between ">
        <div className="flex flex-col gap-[5px]">
          ...
          <span className="text-gray-400 text-little">
            {job?.sector} - {job?.type} - {applicants?.filter(applicant=>applicant.status === "hired").length}/{applicants?.length} Hired
          </span>
        </div>
