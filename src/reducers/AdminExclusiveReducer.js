import {  adminExclusiveOptions, adminExclusiveUtil } from "../utils/constants";

//useReducer with some() for increased readability
function AdminExclusiveReducer(state, action) {
  //Initialise payload as null
  let payload = null;

  //map through the dashboardOptions to compare each option type with action type
  [...adminExclusiveOptions, ...adminExclusiveUtil].some((element) => {
...
export default AdminExclusiveReducer;
