                ...
                <div className="mb-4">
                  ...
                  <p
                    ...
                    dangerouslySetInnerHTML={{
                      __html: employer?.job_description,
                    }}
                  />
                </div>
                ...
                <div className="flex flex-col md:flex-row space-y-4 md:space-y-0 md:space-x-6">
                  <div className="md:w-8/12">
                    ...
                    <div className="mb-4 border-t pt-4 space-y-2">
                      ...
                      <p className="text-gray-600">
                        <strong>Sector:</strong> {employer.sector}
                      </p>
                      <p className="text-gray-600">
                        <strong>Type:</strong> {employer.type}
                      </p>
                      <p className="text-gray-600">
                      ...
                      <p className="text-gray-600">
                        ...
                        <span
                          dangerouslySetInnerHTML={{
                            __html: employer?.experience,
                          }}
                        />{" "}
                      </p>
                      <p className="text-gray-600">
                        <strong>Career Level:</strong> {employer.career_level}
                      </p>
                      <p className="text-gray-600">
                        <strong>Qualification:</strong>{" "}
                        {employer.qualification.join(", ")}
                      </p>
                      <p className="text-gray-600">
                        <strong>Application Deadline:</strong>{" "}
                        {format(
                          new Date(employer.application_deadline_date),
                          "MMMM dd, yyyy"
                        )}
                      </p>
                    </div>
                    ...
                    <div className="mb-4 border-t pt-4 space-y-2">
                      ...
                      <p className="text-gray-600">
                        <strong>Preferred Age:</strong> {employer.preferred_age}
                      </p>
                      <p className="text-gray-600">
                        <strong>Gender:</strong> {employer.gender}
                      </p>
                      <p className="text-gray-600">
                        <strong>Number of Participants:</strong>{" "}
                        {employer.number_of_participants}
                      </p>
                    </div>
                    ...
                    <div className="mb-4 border-t pt-4 space-y-2">
                      ...
                      {employer.introduction_video_url && (
                        <video
                          src={employer.introduction_video_url}
                          controls
                          className="w-full max-w-md h-auto mt-2"
                        />
                      )}
                    </div>
                  </div>
                  ...
                  <div className="md:w-4/12 space-y-9">
                    ...
                    <div className="mb-4 border-t pt-4 space-y-3">
                      <h2 className="font-bold bg-[#F8F8FD] px-2 py-2">
                        About{" "}
                      </h2>
                      <h4 className="text-lg font-semibold text-gray-700">
                      ...
                      <p className="text-gray-600">
                        <strong>Min Salary:</strong> {employer.min_salary}
                      </p>
                      <p className="text-gray-600">
                        <strong>Max Salary:</strong> {employer.max_salary}{" "}
                        {employer.currency}
                      </p>
                      <p className="text-gray-600">
                        <strong>Office Address:</strong>{" "}
                        {employer.office_address}
                      </p>
                      <p className="text-gray-600">
                    ...
                    <div className="border-t pt-8 space-y-2">
                      ...
                      <p className="text-gray-600 mt-2">
                        ...
                        {format(new Date(employer.created_at), "MMMM dd, yyyy")}
                      </p>
                      <p className="text-gray-600">
                        <strong>Updated At:</strong>{" "}
                        {format(new Date(employer.updated_at), "MMMM dd, yyyy")}
                      </p>
                    </div>
                  </div>
                </div>
