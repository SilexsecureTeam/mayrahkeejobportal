...
import { FaArrowLeftLong, FaFacebook, FaInstagram, FaLinkedin, FaTwitter, FaXTwitter } from "react-icons/fa6";
...
const EmployerDetails = () => {
  ...
  const getSocialMediaIcon = (url) => {
    if (url.includes("facebook.com")) return <FaFacebook className="text-blue-500 text-xl" />;
    if (url.includes("twitter.com")) return <FaXTwitter className="text-xl"/>;
    if (url.includes("linkedin.com")) return <FaLinkedin className="text-blue-500 text-xl"/>;
