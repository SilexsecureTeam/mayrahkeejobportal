        ...
        <div className="flex flex-col md:flex-row space-y-4 md:space-y-0 md:space-x-6">
          <div className="md:w-8/12">
            ...
            <div className="mb-4 border-t pt-4 space-y-2">
              ...
              <p className="text-gray-600">
                <strong>Categories:</strong> {job?.search_keywords}
              </p>
              <p className="text-gray-600">
              ...
              <p className="text-gray-600">
                ...
                {formatDate(job?.application_deadline_date)}
              </p>
            </div>
            ...
            <div className="mb-4 border-t pt-4 space-y-2">
              ...
              <p className="text-gray-600">
                <strong>Preferred Age:</strong> {job?.preferred_age}
              </p>
              <p className="text-gray-600">
                <strong>Office Address:</strong> {job?.office_address}
              </p>
              <p className="text-gray-600">
            ...
            <div className="mb-4 border-t pt-4 space-y-2">
              ...
              {job?.introduction_video_url && (
                <video
                  src={job?.introduction_video_url}
                  controls
          ...
          <div className="md:w-4/12 space-y-6">
            ...
            <div className="mb-4 border-t pt-4 space-y-3">
              ...
              <p className="text-gray-600">
                <strong>Min Salary:</strong> {job?.currency} {job?.min_salary}
              </p>
              <p className="text-gray-600">
                <strong>Max Salary:</strong> {job?.currency} {job?.max_salary}
              </p>
              <p className="text-gray-600">
            ...
            <div className="border-t pt-4 space-y-2">
              <h4 className="text-lg font-semibold text-gray-700 bg-slate-100 px-2 py-2">
                Status and Timestamps
              </h4>
              <p className="text-gray-600">
                <strong>Status:</strong>{" "}
                {job?.status === "1" ? "Inactive" : "Active"}
              </p>
              ...
              <p className="text-gray-600">
                <strong>Updated At:</strong> {formatDate(job?.updated_at)}
              </p>
            </div>
          </div>
        </div>
