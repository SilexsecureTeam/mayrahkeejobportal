...
// import {profileImg} from "../../assets/pngs/Admin-Dashboard/";
    ...
    return (
        <>
            <aside className="w-[18%] hidden h-full items-center bg-secondaryColor px-2 pb-2 md:flex flex-col justify-start overflow-y-auto">
                ...
                <h1 className="pb-4 fonr-bold">Admin</h1>
            ...
            >
                <div className="flex items-center gap-[10px] my-4">
                    ...
                    />
                    <img src={mainLogoTwo} className="w-[60%] max-w-[150px]" />
                </div>
                <div className="flex flex-col items-center gap-[10px] mb-4">
                    <img src="/src/assets/pngs/approved.png" alt="admin profile" className="h-[70px] w-[70px] rounded-full mb-2" />
