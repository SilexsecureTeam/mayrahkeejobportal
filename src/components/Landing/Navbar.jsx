    ...
    <nav className="fixed top-0 right-0 left-0 z-20 max-w-[1200px] min-h-20 w-full mx-auto bg-white flex p-3 justify-between items-center flex-wrap md:flex-nowrap">
      ...
      <div
        className={`${menu
          ...
          } lg:flex lg:flex-row lg:static lg:bg-transparent lg:items-center lg:gap-4 my-3 mx-auto gap-2 font-semibold order-1 w-full lg:w-auto lg:order-0 *:p-2 *:rounded-md *:cursor-pointer hover:*:hover:bg-slate-300`}
      >

        <NavLink to="/">Home</NavLink>
        <NavLink to="/pages">Find Jobs</NavLink>
