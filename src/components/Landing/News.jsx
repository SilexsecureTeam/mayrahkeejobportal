        ...
        <div className="bg-[#47aa4910]">
            ...
            {(recent || news.length > 0) ? (
                        ...
                        {news.map((newsItem) => (
                            ...
                            >
                                ...
                                <div className="p-2 flex-1 w-[90%] md:w-full flex flex-col justify-center">
                                    ...
                                    <p
                                        className="text-sm text-gray-500 mb-1 md:mb-3"
                                        dangerouslySetInnerHTML={{ __html: `${newsItem?.description?.slice(0, 60)}...` }}
                                    ></p>
                ...
                <div className="text-center py-12 text-gray-500">
                    <img
                        src="https://via.placeholder.com/200?text=No+Blogs"
                        alt="No Blogs"
                        className="mx-auto mb-4"
                    />
                    <p className="text-lg font-semibold">No blog posts available at the moment.</p>
