  ...
  return (
    <div className="bg-gray-100  mt-20 py-6 flex flex-col items-center">
      <section className="max-w-[900px] w-[90%] flex flex-col items-center">
        ...
        {<article className="w-max flex items-center justify-between mx-auto">
      ...
      {<figure className="w-full h-80 my-4">
        <img src={`${img ? img : "https://via.placeholder.com/150/000000/FFFFFF?text=Image+Not+Found"}`} alt="image" className="rounded mb-4 w-full h-full object-cover" />
      </figure>}
    </div>
  );
};
